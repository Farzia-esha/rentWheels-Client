...
import { Car, LogOut, Menu, X, ChevronDown, LayoutDashboard } from 'lucide-react';
          ...
          <div className="hidden lg:flex items-center">
            {user ? (
              <div className="user-dropdown relative">
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl py-3 text-gray-800">
                    ...
                    <Link
                      to="/dashboard"
                      className="flex items-center gap-2 px-4 py-2 hover:bg-purple-600 hover:text-white"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 w-full px-4 py-2 hover:bg-purple-600 hover:text-white"
                    >
                      <LogOut size={16} />
                      Logout
                    </button>
              ...
              <Link
                to="/login"
                className="bg-white text-purple-700 px-6 py-2 rounded-lg font-semibold hover:bg-blue-50"
              >
                Login / Signup
              </Link>
            )}
          ...
          <div className="lg:hidden pb-4 space-y-2">
            ...
            {user ? (
              ...
              <Link
                to="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="block text-center mt-3 bg-white text-purple-700 py-2 rounded-lg font-semibold"
              >
                Login / Signup
              </Link>
            )}
